...
<body>
  ...
  <section class="home text-center d-grid align-items-center mb-3 justify-content-center" id="home">
    <div class="container-fluid text-light">
      ...
      <a class="fade-up shop_now py-2" href='menu/index.php' type="button">Shop
        Now</a>
    </div>
  </section>
  <!-- Home End -->
    ...
    <div class="category container-fluid">
      ...
      <div class="row align-items-center justify-content-center">
        <div class="sub-category col-4 m-2 mt-0 d-flex align-items-center justify-content-center text-light"><a
            class="cat_dslr" href="/menu/index.php">DSLR</a></div>
        <div class="sub-category col-4 m-2 mt-0 d-flex align-items-center justify-content-center text-light"><a
            class="cat_mirrorless" href="/menu/index.php">Mirrorless</a></div>
        <div class="sub-category col-4 m-2 mt-0 d-flex align-items-center justify-content-center text-light"><a
            class="cat_tripod" href="/menu/index.php">Tripod</a></div>
      </div>
    </div>
  </section>
  <!-- Category End -->
  ...
  <section class="top-product my-4">
    <div class="container-fluid">
      ...
      <div class="row align-items-center justify-content-center my-5">
        <a href="/menu/detail.php?id=2" class="product col-3 m-2 p-4">
        ...
        <a href="/menu/detail.php?id=1" class="product col-3 m-2 p-4">
        ...
        <a href="/menu/detail.php?id=3" class="product col-3 m-2 p-4">
