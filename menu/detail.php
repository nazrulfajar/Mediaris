...
$d = mysqli_fetch_array($query) or die ("Query failed: " . mysqli_error($config));
?>
  ...
  <section>
    <div class="container">
      ...
      <div class="listproduct row align-items-center justify-content-center my-5">
        ...
        ?>
        <div class="product col-3 m-2 p-4">
        <a href="detail.html?item_id="<?= $d['item_id'] ?>>
        <img src=<?php echo $d['img']; ?>>
        <h2 class="p-1 pt-5 my-1"><?= $d['model'] ?></h2>
        <h4 class="p-1"><?= $d['rental_fee'] ?></h4>
        </a>
        </div>
        <?php
        }
